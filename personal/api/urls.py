...
urlpatterns = [
    ...
    re_path(r"staffhome/editreference/(?P<slug>[\w-]+)/", CommunityUpdateView.as_view(), name="edit_reference"),
    re_path(r"staffhome/deletereference/(?P<slug>[\w-]+)/", CommunityDeleteView.as_view(), name="delete_reference"),
